(function ($) {
    ...
    CPFields.prototype = {
        getCPFields : function () {
            // will provide all fields with respect to element
            return this._items;
        },
        getSimplyfyCPFields : function () {
            // get only fields data
            var fields = {};
            $.each(
                this._items, function (i, item) {
