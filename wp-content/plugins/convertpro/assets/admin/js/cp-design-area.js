...
(function ($) { 
    ...
    ConvertProDragDrop = {
        ...
        init: function () {
            ...
            .on(
                'cpro_init_drag', function ( event, selector, obj ) {
            ...
            .on(
                'cpro_init_drop_on_panel', function () {
        ...
        _iterateGuidelines: function ( obj, ui, grouping ) {
            ...
            $.each(
                guides, function ( i, guide ) {
                    $.each(
                        elemGuides, function ( i, elemGuide ) {
    ...
    ConvertProGrouping = {
        ...
        _generateBigGhost: function ( current_obj, is_selection ) {
            ...
            parent.find(".cp-field-html-data").each(
                function () {
                    var result = false;
        ...
        _doObjectsCollide: function ( parent_obj, a, b ) {
    ...
    ConvertProPanel = {
        ...
        init: function ( e ) {
            ...
            .on(
                'click', '.cp-show-panel-settings', function (e) {
            ...
            .on(
                'click', '.panel-wrapper:not("#cp-group-grid")', function (e) {
            ...
            .on(
                "change", ".cp-api-fields input", function (e) {
        ...
        _onPanelKeyDown: function (e) {
            ...
            // Move fields using keyboard arrow keys
                ...
                if (sel_element.length == 1 && sel_element.find('.mce-edit-focus').length == 0 ) {
                    ...
                    cp_move_field_timer = setTimeout(
                        function () {
