    ...
    var ConvertProMobileEditor = {
        ...
        init: function ( e ) {
            ...
            $(document)
                ...
                .on(
                    'click', '.cp-regenerate-mobile', function (e) {
                ...
                .on(
                    'click', '.cp-dialog-regnerate-mobile-cancel', function (e) {
                        e.preventDefault();
                ...
                .on(
                    "click", ".cp-shrink-mob-opt", function (e) {
                        e.preventDefault();
                        e.stopPropagation();
            ...
            $('.cp-devices-button-wrapper a').on(
                'click', function (e) {
                    e.preventDefault();
        ...
        _resetMobileData: function ( current_panel, new_elements ) {
            ...
            //mobile / desktop
            $.each(
                r_panel_data, function (index, val) {
                    ...
                    if(!$.isEmptyObject(r_panel_data) && 'common' !== index ) {
                        ...
                        $.each(
                            r_panel_data[index], function (id, obj) {

                                $.each(
                                    obj, function (prop, prop_value) {
