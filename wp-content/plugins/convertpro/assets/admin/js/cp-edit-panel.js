...
(function ($) { 
    ...
    ConvertProEditPanel = {
        ...
        init: function () {
            ...
            .on(
                'click', '.cp-edit-panel-content .ui-tabs-panel:not(.change_icon)', function (e) {
        ...
        */
        _handleDependency: function () {
            ...
            $(".cp-edit-panel-content").find(".cp-edit-panel-field").each(
                function (index, el) {
        ...
        _renderTemplate: function ( template, replace_object, value, optional_val ) {
            ...
            $.each(
                replace_object, function ( key, obj_value ) {
                ...
                break;
                    ...
                    case "font":
                        ...
                        $.each(
                            parsed_obj, function (index, val) {    
                                if('cp_font_par' == val.id ) {
                                    var font_options = val.options;    

                                    $.each(
                                        font_options, function (index, val) {
                                    
                                            dropdown_options += "<optgroup label='"+index+"'>";

                                            $.each(
                                                val , function ( font_index, font_val ) {
                        ...
                        $.each(
                            font_weight_options, function (index, val) {
        ...
        _open_edit_panel: function ( e, element, force_hide, apply_respective, field_name ) {
            ...
            if (apply_respective ) {
                if(typeof temp.sections !== 'undefined' ) {
                    $.each(
                        temp.sections, function ( k, v ) {
                            $.each(
                                v.params, function ( index, val ) {
                            ...
                            if(!$.isEmptyObject(field.sections) ) {
                                ...
                                if(( field.id == "cp_shape" ) && typeof field.presets != 'undefined' ) {
                                    ...
                                    if(shapePresets.length > 0 ) {
                                        $.each(
                                            shapePresets, function ( key, value ) {
                                ...
                                if(force_hide == false ) {
                                        ...
                                        $.each(
                                            dependency_elements , function (index, val) {
                                    ...
                                    if(step_value !== '' ) {
                                        $('#btn_step').val(step_value);
                                            ...
                                            $('.cp-edit-panel-wrapper .has-tip').each(
                                                function (i,tip) {
                                                    $tip = $(tip);
                                                    ...
                                                    $.each(
                                                        param_types, function (index, val) {
